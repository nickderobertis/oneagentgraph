...
/// nothing delivers it here.** Re-read on 2026-09-20 against the two engines
...
/// and the `onejudge` engine loop is byte-identical from 0.13.1 to 0.13.3,
...
/// * `onejudge` 0.13.3 publishes `Observation::Message` **after**
