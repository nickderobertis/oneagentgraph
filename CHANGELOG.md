...
## [0.5.2](https://github.com/nickderobertis/oneagentgraph/compare/v0.5.1...v0.5.2) - 2026-09-24

### Fixed

- *(scratch)* enumerate every pid on macOS, not the newest quarter ([#160](https://github.com/nickderobertis/oneagentgraph/pull/160))
...
- *(event)* [**breaking**] own the event vocabulary and send notes through onejudge ([#152](https://github.com/nickderobertis/oneagentgraph/pull/152))

## [0.4.10](https://github.com/nickderobertis/oneagentgraph/compare/v0.4.9...v0.4.10) - 2026-09-22

### Added

- *(deps)* link the oneharness core that resolves an extends chain ([#150](https://github.com/nickderobertis/oneagentgraph/pull/150))
...
- *(sweep)* report the sweep as JSON with owned families, and take a decimal age floor ([#140](https://github.com/nickderobertis/oneagentgraph/pull/140))
...
- *(deps)* link the onemessagebus release without the onejudge codec and onejudge protocol v8 ([#119](https://github.com/nickderobertis/oneagentgraph/pull/119))

## [0.4.2](https://github.com/nickderobertis/oneagentgraph/compare/v0.4.1...v0.4.2) - 2026-09-14

### Changed

- *(event)* take the envelope, the filter, the emitter and the note transport from onemessagebus ([#115](https://github.com/nickderobertis/oneagentgraph/pull/115))

## [0.4.1](https://github.com/nickderobertis/oneagentgraph/compare/v0.4.0...v0.4.1) - 2026-09-14

### Added

- *(deps)* link the onejudge that names the artifacts a judge reads ([#111](https://github.com/nickderobertis/oneagentgraph/pull/111))
...
- *(graph)* declare which members are background, and settle a run once only background members survive ([#99](https://github.com/nickderobertis/oneagentgraph/pull/99))

## [0.3.17](https://github.com/nickderobertis/oneagentgraph/compare/v0.3.16...v0.3.17) - 2026-09-11

### Fixed

- *(deps)* link the oneharness-core and onejudge that run a controlled codex turn under its own model ([#97](https://github.com/nickderobertis/oneagentgraph/pull/97))

## [0.3.16](https://github.com/nickderobertis/oneagentgraph/compare/v0.3.15...v0.3.16) - 2026-09-11

### Added

- *(event)* say who authored each turn a member publishes ([#95](https://github.com/nickderobertis/oneagentgraph/pull/95))

## [0.3.15](https://github.com/nickderobertis/oneagentgraph/compare/v0.3.14...v0.3.15) - 2026-08-30

### Added

- route a role-addressed note to whichever side of a member is live ([#92](https://github.com/nickderobertis/oneagentgraph/pull/92))

## [0.3.14](https://github.com/nickderobertis/oneagentgraph/compare/v0.3.13...v0.3.14) - 2026-08-29

### Fixed

- reconcile a member death against the record beside it, and narrow the terminal-blocker escape ([#90](https://github.com/nickderobertis/oneagentgraph/pull/90))
...
- *(deps)* adopt onejudge 0.6.1 and prove settle_on_noop reaches the loop ([#84](https://github.com/nickderobertis/oneagentgraph/pull/84))
